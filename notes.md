...
* [https://github.com/tiernano/OpenGNARBOX/blob/main/found_files/firstboot-docker] seems to do stuff related to first boot for docker. Quick glance seems to copy a file named "firstboot.*.tar.gz" to /media/GNARBOX, extracts it and copies any images into docker...
* file named libfirstboot.bash points at /boot/efi/keys/app-data.key.blob as an encrypted key and /tmp/app-data.key as decrypted... 
